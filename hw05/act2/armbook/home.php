...
if($has_session){
	...
	if (!isset($_SESSION['login']) or !isset($_SESSION['user_id'])){
		...
		session_destroy();
		die("<script nonce=\"YWhhaGEK\">window.location.href = '/index.php';</script>Invalid Session");
	}
...
<input hidden id="id_to_get" value="<?php echo $id_to_get; ?>">
	...
	<div id="global">
			<div id="basic_profile">
				...
				if($_SESSION['user_id'] == $id_to_get){
					echo '<script src="js/home.js" nonce="YWhhaGEK"></script>';
				...
				<a class="links" id="friends" href="#">Friends<span></span></a>
