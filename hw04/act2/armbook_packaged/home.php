...
<script src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/jqueryui-editable/js/jqueryui-editable.min.js"></script>
	...
	<!-- FIX: Print CSRF token here -->
	<input hidden id="csrf_token" value="<?php echo($_SESSION['csrf_token']); ?>">
	<!-- END FIX -->
	...
	$( document ).ready(function() {
		...
		$( "#add_friend" ).click(function() {
			...
			// FIX: Sending the CSRF token with the get request
			var csrf_token = $("#csrf_token").val();
			$.get( "add_friend.php?id=<?php echo $id_to_get; ?>&csrf_token=" + csrf_token.toString(), function( data ) {
			  event.preventDefault();
			});
			// END FIX
		...
		$( "#del_friend" ).click(function() {
			...
			// FIX: Sending the CSRF token with the get request
			var csrf_token = $("#csrf_token").val();
			$.get( "del_friend.php?id=<?php echo $id_to_get; ?>&csrf_token=" + csrf_token.toString(), function( data ) {
			  event.preventDefault();
			});
			// END FIX
